  ...
  return (
    <section className="mb-12">
      ...
      <p className="text-[19.2px] leading-[28.8px] text-text-body mb-6">
        ...
        <a href="https://www.linkedin.com/in/gb-jeong/" target="_blank" rel="noopener noreferrer" className="text-stanford-red hover:underline"> Team Attention</a>이 번역하고 있습니다.
      </p>
